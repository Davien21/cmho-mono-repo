        ...
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              ...
              formError && 'border-destructive ring-destructive/20 dark:ring-destructive/40',
              className,
              open && 'outline outline-2 outline-blue-500 outline-offset-4 ring-2 ring-blue-600'
            )}
            disabled={disabled}
          >
